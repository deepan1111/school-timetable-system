...
//       <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-to-br from-blue-400/20 via-indigo-400/20 to-purple-400/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 animate-float"></div>
//       <div className="absolute top-1/3 right-0 w-[400px] h-[400px] bg-gradient-to-tl from-cyan-300/15 to-blue-300/15 rounded-full blur-3xl translate-x-1/3 animate-float-delayed"></div>
//       <div className="absolute bottom-0 left-1/4 w-[350px] h-[350px] bg-gradient-to-tr from-indigo-300/15 to-purple-300/15 rounded-full blur-3xl translate-y-1/2 animate-float-slow"></div>
...
//               <div className="w-1.5 h-16 bg-gradient-to-b from-blue-600 via-indigo-600 to-purple-600 rounded-full shadow-lg shadow-blue-500/20"></div>
//               <div>
...
//                   Admin Dashboard
//                 </h1>
//                 <p className="text-slate-600 text-lg font-medium mt-2 tracking-wide">Manage standards and sections efficiently</p>
//               </div>
//             </div>
//           </div>
//           <button
...
//           <div className="flex justify-center gap-3 bg-gradient-to-r from-slate-100/80 via-blue-50/50 to-slate-100/80 p-2.5 rounded-2xl">
//             <button
//               onClick={() => setActiveTab("timetable")}
//               className={`relative flex-1 font-bold px-10 py-5 rounded-xl transition-all duration-500 transform hover:scale-[1.02] active:scale-95 ${
//                 activeTab === "timetable"
...
//           className={`${
//             activeTab === "timetable" 
//               ? "bg-white/70 backdrop-blur-2xl rounded-3xl p-10 shadow-2xl border border-white/40 animate-fadeIn" 
//               : "hidden"
//           }`}
//         >
//           <div className="mb-10">
...
//                   Class Timetable
//                 </h2>
//                 <p className="text-slate-600 font-semibold text-base mt-1">Manage and edit timetable of all classes</p>
//               </div>
//             </div>
//           </div>
...
//                   <div className="absolute -inset-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-700"></div>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//                   Teachers Management
//                 </h2>
//                 <p className="text-slate-600 font-semibold text-base mt-1">Manage teachers and their assignments</p>
//               </div>
//             </div>
//           </div>
...
//           0%, 100% { transform: translate(33%, 0) translateY(0px) rotate(0deg); }
//           50% { transform: translate(33%, 0) translateY(20px) rotate(-5deg); }
//         }
        
//         @keyframes float-slow {
//           0%, 100% { transform: translate(0, 50%) translateX(0px); }
//           50% { transform: translate(0, 50%) translateX(20px); }
//         }
...
const Dashboard = () => {
  ...
  const quickStats = [
    ...
    { 
      label: 'Total Classes', 
      value: stats?.totalClasses || Object.keys(standardSections).length, 
      icon: '📚', 
      ...
      <div className="relative z-10 p-8 max-w-[1800px] mx-auto">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-slate-600 text-lg font-semibold mt-2">{formatDate(currentTime)}</p>
              </div>
            </div>
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[1,2,3,4].map((i) => (
              <div key={i} className="bg-white/70 backdrop-blur-2xl rounded-2xl p-6 shadow-xl border border-white/40 animate-pulse">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <p className="text-slate-600 font-semibold text-sm mb-2">{stat.label}</p>
                    <h3 className="text-5xl font-black bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
                      {stat.value}
                    </h3>
                    <div className={`mt-2 flex items-center gap-1 text-sm font-bold ${stat.trendUp ? 'text-emerald-600' : 'text-red-600'}`}>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white/70 backdrop-blur-2xl rounded-3xl p-10 shadow-2xl border border-white/40">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <button className="group bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-blue-100/50 transition-all duration-500 transform hover:scale-105 text-left">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 mb-2">Manage Timetables</h3>
                    <p className="text-slate-600 font-medium">Create and edit class schedules</p>
                  </button>

                  <button className="group bg-gradient-to-br from-emerald-50 to-green-50 hover:from-emerald-100 hover:to-green-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-emerald-100/50 transition-all duration-500 transform hover:scale-105 text-left">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 mb-2">Manage Teachers</h3>
                    <p className="text-slate-600 font-medium">Add and assign teachers</p>
                  </button>
                  ...
                  <button className="group bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-purple-100/50 transition-all duration-500 transform hover:scale-105 text-left">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 mb-2">View Reports</h3>
                    <p className="text-slate-600 font-medium">Analytics and insights</p>
                  </button>
                  ...
                  <button className="group bg-gradient-to-br from-orange-50 to-red-50 hover:from-orange-100 hover:to-red-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-orange-100/50 transition-all duration-500 transform hover:scale-105 text-left">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 mb-2">Settings</h3>
                    <p className="text-slate-600 font-medium">System configuration</p>
                  </button>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  {recentActivity.length > 0 ? (
                    recentActivity.slice(0, 5).map((activity, index) => (
                      <div key={index} className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-4 border border-slate-100">
            ...
            <div className="mb-10">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-semibold text-base mt-1">Monitor all system activities and logs</p>
                </div>
              </div>
            </div>
              ...
              {recentActivity.length > 0 ? (
                recentActivity.map((activity, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-lg font-bold text-slate-800">{activity.description}</h4>
                ...
                <div className="text-center py-20">
                  ...
                  <p className="text-slate-500 text-xl font-semibold">No activity recorded yet</p>
                </div>
              )}
            </div>
          </section>
